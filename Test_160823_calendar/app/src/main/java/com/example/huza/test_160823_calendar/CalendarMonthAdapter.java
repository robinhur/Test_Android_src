...
public class CalendarMonthAdapter extends BaseAdapter {
    ...
    public static final String TAG = "HuZA_Calendar";
    ...
    HashMap<String, String> scheduleHash;
    ...
    private void init() {
        ...
        scheduleHash = new HashMap<String, String>();
    }
    ...
    public String getSchedule(int year, int month, int position) {
        String keyStr = year + "-" + month + "-" + position;
        String outStr = scheduleHash.get(keyStr);

        return outStr;
    }

    public String getSchedule(int position) {
    ...
    public void putSchedule(int year, int month, int position, String scheduleStr) {
        String keyStr = year + "-" + month + "-" + position;
        scheduleHash.put(keyStr, scheduleStr);
    }

    public void putSchedule(int position, String scheduleStr) {
        String keyStr = curYear + "-" + curMonth + "-" + position;
        scheduleHash.put(keyStr, scheduleStr);
    }
}
