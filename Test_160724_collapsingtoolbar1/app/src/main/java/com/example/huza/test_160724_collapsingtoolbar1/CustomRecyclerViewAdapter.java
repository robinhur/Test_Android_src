package com.example.huza.test_160724_collapsingtoolbar1;
...
public class CustomRecyclerViewAdapter extends RecyclerView.Adapter<CustomRecyclerViewAdapter.myViewHolder> {
    ...
    String[] title_arr = {"Chapter One", "Chapter Two", "Chapter Three", "Chapter One2", "Chapter Two2", "Chapter Three2", "Chapter One3", "Chapter Two3", "Chapter Three3", "Chapter One4", "Chapter Two4", "Chapter Three4", "Chapter Four"};
